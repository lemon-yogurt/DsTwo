...
<s:form action="Gupdate"  method="post" enctype="multipart/form-data" role="form" class="forms"> 
 
  <table class="ss">
           <tr class="tt"><td class="sp">编号：</td><td class="sp2">    <s:textfield name="greenbuild.id" readonly="true" class="form-control" id="greenbuild.id"/>
       </td></tr>
