...
<div class="container xs">
  <div class="row">
     ...
     <div class="col-sm-3">
      ...
      <li class="text-center aa"><a href="SfindallC">校招信息</a></li>
    ...
    <div class="col-sm-8">
     <s:form action="SfindbyEverything"  method="post" enctype="multipart/form-data" role="form" class="forms" > 
           <table class="ss">         
              <tr class="tt"><td class="sp2">   
              <s:textfield name="schoolre.ss" class="form-control" id="schoolre.ss" placeholder="请输入搜索内容" style="width:500px;"/></td></tr> 
              
              <s:submit value="搜索"  class="btn btn-default" style="width:30%;margin-top:20px;background:#90EE90;" />
           </table> 
        </s:form>
        <h5>	<a href="index.jsp">首页</a>>>校招信息展示</h5>
        <hr class="simple" color="#6f5499" />
        <s:iterator value="schoolres" >
           <div class="row hh">
             <a href="Sfindbyid?a=<s:property value="id"/>" class="hh">
             <div class="col-sm-3 ">
          ...
          if(session.getAttribute("admin")!=null)
            ...
            if(Ma.equals("管理员")){
         %>  
         <a href="Sdelete?a=<s:property value="id"/>" class="btn btn-danger" style="width:10%">删除</a>
          <a href="Supdatefind?a=<s:property value="id"/>" class="btn btn-danger" style="width:10%">修改</a>
         <% }%>
          <hr class="simple" color="#6f5499" />
        </div>
        </s:iterator>
