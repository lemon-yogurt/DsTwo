...
<div class="container xs">
  <div class="row">
     ...
     width:1px;
      ...
      <div class="col-sm-8">
       <s:form action="QfindbyEverything"  method="post" enctype="multipart/form-data" role="form" class="forms" > 
           <table class="ss">         
              <tr class="tt"><td class="sp2">   
              <s:textfield name="question.ss" class="form-control" id="question.ss" placeholder="请输入搜索内容" style="width:500px;"/></td></tr> 
           ...
           <div class="hh">
             <a href="Cfindbyqid?a=<s:property value="id"/>">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-8">
                     <div class="xm"> <s:property value="title"/></div>
                     </div  >
                     <div class="col-sm-2">
                      <div class="xx"> <img src="images/<s:property value="img"/>" style="width:100%;"></div>
                    </div>
