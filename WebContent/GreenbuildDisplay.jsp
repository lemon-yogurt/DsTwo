  ...
  <div class="row">
     ...
     <div class="col-sm-3">
       <ul class="nav nav-pills nav-stacked my">
          ...
          <li class="text-center aa"><a href="GfindallC">绿建信息</a></li>
          <li class="text-center"><a href="PfindallC">政策信息</a></li>
    ...
    <div class="col-sm-8">
        ...
        <s:form action="GfindbyEverything"  method="post" enctype="multipart/form-data" role="form" class="forms" > 
           <table class="ss">         
              <tr class="tt"><td class="sp2">   
              <s:textfield name="greenbuild.ss" class="form-control" id="greenbuild.ss" placeholder="请输入搜索内容" style="width:500px;"/></td></tr> 
              
              <s:submit value="搜索"  class="btn btn-default" style="width:30%;margin-top:20px;background:#90EE90;" />
           </table> 
        </s:form>
        
        <h5>	<a href="index.jsp">首页</a>>>绿建信息展示</h5>
        <hr class="simple" color="#6f5499" />
        <s:iterator value="greenbuilds" >
           <div class="row hh">
             <a href="Gfindbyid?a=<s:property value="id"/>" class="hh">
             <div class="col-sm-3 ">
          ...
          if(session.getAttribute("admin")!=null)
            ...
            if(Ma.equals("管理员")){
         %>  
         <a href="Gdelete?a=<s:property value="id"/>" class="btn btn-danger" style="width:10%">删除</a>
          <a href="Gupdatefind?a=<s:property value="id"/>" class="btn btn-danger" style="width:10%">修改</a>
         <% }%>
          <hr class="simple" color="#6f5499" />
        </div>
        </s:iterator>
