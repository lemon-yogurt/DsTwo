...
<%@include file="mynav.jsp" %>
  <h5>	<a href="index.jsp">首页</a>>>修改管理员</h5>
...
<s:form action="Aupdate"  method="post" enctype="multipart/form-data" role="form" class="forms"> 
 
  <table class="ss">
    <tr class="tt"><td class="sp">编号：</td><td class="sp2">    <s:textfield name="administrator.id" readonly="true" class="form-control" id="administrator.id"/>
       </td></tr>
